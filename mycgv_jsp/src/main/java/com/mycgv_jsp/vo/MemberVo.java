...
/*
 * 폼 -> email1, email2, addr2, addr2, phone1, phone2, phone3
 * 테이블 -> rno, email, addr, pnumber, hobbytList, mdate
...
public class MemberVo {
	 ...
	 * 		 -> 폼에서 get O(email1+"@"+email2), 테이블 get O
	 */
	...
	public String getEmail() {
		if(email1 != null) { //폼에서 이메일 주소가 넘어온 경우
			email = email1 + "@" + email2;
		}
		return email;
	}
